...
def compare_circuits(num_wires, params):
    ...
    # QHACK #
    # define devices
    dev_state = qml.device('default.qubit', num_wires)
    dev_density = qml.devices.default_mixed.DefaultMixed(num_wires)
    ...
    def pure_circuit():
        ...
        # Apply a y rotation to all wires in the circuit
